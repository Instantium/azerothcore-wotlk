...
void ScriptMgr::OnUnequip(Player* player, Item* it, uint8 bag, uint8 slot, bool update)
{
    CALL_ENABLED_HOOKS(PlayerScript, PLAYERHOOK_ON_UNEQUIP, script->OnUnequip(player, it, bag, slot, update));
}
